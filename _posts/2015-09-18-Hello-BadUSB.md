...
## What is BadUSB?
BadUSB can be any USB device. It is possible for hackers to reprogram micro-controllers of normal devices or cloak their malicious devices to look like regular ones. BadUSB can for example upload a virus to your computer, redirect your internet traffic or pretend to be a keyboard. Probably the most famous use of USB drives in a cyberattack was [stuxnet](http://arstechnica.com/tech-policy/2011/07/how-digital-detectives-deciphered-stuxnet-the-most-menacing-malware-in-history/). USB drives were used for getting virus into computers that were not connected to the other world. 
