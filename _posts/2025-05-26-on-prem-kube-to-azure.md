...
Next was preparing the JWKS file content. The AWS instructions suggested creating a new key pair, but I wanted to use the existing one. By checking `k0scontroller.service` status on my cluster host, I found the location of the current public key.
