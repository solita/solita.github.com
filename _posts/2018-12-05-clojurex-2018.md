...
More than half of the participants had used Clojure over 3 years.
...
He coined the term "Maps Fatique" to describe the tension of building, converting and maintaining hierarchical in-memory data presentation in programs while coping with changing requirements.

![Maps fatique](/img/clojure-2018/maps-fatique.jpg).
...
The talk pointed to good reading resource, recomended by Rich Hickey himself :) [Foundations of Databases](http://webdam.inria.fr/Alice/).
...
Perhaps due to the fact that this was a lightning talk, we didn't get to hear further details how the implementation went.
