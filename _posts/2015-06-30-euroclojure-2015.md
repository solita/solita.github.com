...
Adam has written a tool with Clojure called [code-maat](https://github.com/adamtornhill/code-maat) which is a command line tool for doing temporal analysis from version control data. The tool is language agnostic and can read log data from Git, Mercurial, SVN and Perforce. He also has written a whole book about this concept called Your *[Code as a Crime Scene](https://paraprog.com/book/atcrime/your-code-as-a-crime-scene)*.
