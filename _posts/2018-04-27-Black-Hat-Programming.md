...
author: lokori
excerpt: Explore the art of Black Hat Programming, which is anything but your regular professional software development. How to exploit security vulnerabilities with Python like a pro? 
tags:
- Python
- hacking
- infosec
...
## What is this Black Hat Programming

Quite simply, Black Hat Programming is the art of writing tools and scripts for penetration testing and expoiting
vulnerabilities. There are significant differences compared to professional software development. These are typical
characteristics of the programs discussed here:
...
have a lot of libraries ready to do the heavy lifting. Java, C# and many others are qualified in this sense.
...
black hat programmer doesn't want to spend time designing types and classes and wondering what **erasure** or **generics** means. It's
about the speed of development - just hack together the idea, test until it stops bleeding.. and profit! Cowboy coding has finally
found it's proper place in the world.

It is no wonder that Python is the absolute favorite of pen testers and hackers
all over the world. Perl might become a distant second and there is Ruby as the exception to the general rule because
the widely used [Metasploit](https://www.metasploit.com/) is Ruby-based. But Python is the high-king of this realm and a very well liked king he is. 
Long may he reign!
...
The scanner takes necessary information for the scan from command line arguments. Then it simply sends requests in a single thread and detects open ports based on the reply
it gets from the squid proxy. After every 19th requested port it reports that it's still running so that we can see progress. Very straightforward, not stealthy really or
very professional. Yet, very handy.
...
The [CVE-2017-5638](https://www.cvedetails.com/cve/CVE-2017-5638/) is one link in a long chain of RCE vulnerabilities related to OGNL handling in Apache Struts. For example, see [CVE-2013-1965](https://www.cvedetails.com/cve/CVE-2013-1965/), [CVE-2013-2134](https://www.cvedetails.com/cve/CVE-2013-2134/) or [CVE-2016-4461](https://www.cvedetails.com/cve/CVE-2016-4461/). Input handling is still difficult.
...
If this looks like something you would love to do, please go ahead and start hacking! I recommend [Hack The Box](https://www.hackthebox.eu) as a platform where to hone and test
your skills. But there are also books. [Black Hat Python](https://www.amazon.com/Black-Hat-Python-Programming-Pentesters/dp/1593275900) contains more examples of Black Hat Programming shown in this blog post.
